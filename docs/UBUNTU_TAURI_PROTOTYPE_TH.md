...
- Settings ยังมี `fontName`, `fontSize`, `wordWrap`, `showLineNumbers`, `zoom`, `theme`
...
```bash
git tag ubuntu-v1.1.1
git push origin ubuntu-v1.1.1
```
...
- ปรับ theme, word wrap, line numbers, font size และ zoom ได้
